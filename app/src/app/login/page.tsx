  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="bg-white rounded-2xl shadow-sm border p-10 w-full max-w-sm text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-1">GroupPlan</h1>
        <p className="text-gray-500 text-sm mb-8">小团体活动管理，从此不乱</p>

        {error && (
          <p className="text-red-500 text-sm mb-4">登录失败，请重试</p>
        )}
        ...
        <p className="text-xs text-gray-400 mt-6">需要邀请链接才能加入群组</p>
      </div>
    </div>
  )
}
